...
class ImportTargets extends \App\Controllers\BaseController {
	...
	public function index(){
		$data = array();
		$this->load->view('Generated/target/importtargets_view', $data);
	}
