...
class ImportApplications extends \App\Controllers\BaseController {
	...
	public function index(){
		$data = array();
		$this->load->view('Generated/application/importapplications_view', $data);
	}
	 ...
	 * @return multitype:ApplicationModel
	 */
