            ...
            <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark navbar fixed-top">
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    ...
                    <ul class="nav nav-pills flex-column mb-auto">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url() ?>/Generated/Application/Listapplications" class="nav-link text-white <?php if($menu == "Application"){?>active<?php } ?>">
                                Applications
                            </a>
                        </li>
                        <?php } ?>
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url() ?>/Generated/Trace/Listtraces" class="nav-link text-white <?php if($menu == "Trace"){?>active<?php } ?>">
                                Traces
                            </a>
                        </li>
