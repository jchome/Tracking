...
?>
	...
	<div class="control-group"><!-- Login : Login de connexion -->
	...
	<div class="control-group"><!-- E-mail : E-mail de l'utilisateur -->
		<label class="col-md-2 control-label" for="email"><?= lang('generated/user.form.email.label') ?> :</label>
		<div class="controls">
		<input class="form-control" type="text" name="email" id="email" value="<?= $user->email ?>"  >
			<span class="help-block"><?= lang('generated/user.form.email.description')?></span>
		</div>
	</div>
