...
?>
	...
	<div class="control-group"> <!-- email : E-mail -->
		<label class="control-label" for="email">
			<?= lang('generated/user.form.email.label') ?> :
		</label>
		<div class="controls"><input class="input-xlarge valtype form-control" type="text" name="email" id="email"  >
			<span class="help-block valtype"><?= lang('generated/user.form.email.description')?></span>
		</div>
	</div>
